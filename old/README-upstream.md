# autoXRAY — оригинальная документация (xVRVx)

> Это README из upstream-репозитория [xVRVx/autoXRAY](https://github.com/xVRVx/autoXRAY).  
> Актуальная инструкция для форка с мульти-клиентами: [../README.md](../README.md)
